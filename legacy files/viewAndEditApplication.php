	  ...
	  // Connect to the database
				...
				if (isset($_POST['submit'])) {
				  ...
				  if (!empty($firstName) && !empty($lastName) && !empty($nationalID) && !empty($emailAddress) && !empty($ALIndexNumber) && !empty($ALYear) && !empty($OLIndexNumber) && !empty($OLYear) && !empty($adminDistrict) && !empty($preference01)) {
					  ...
					  $query = "UPDATE application SET title = '$title',  firstName = '$firstName', otherNames = '$otherNames', lastName = '$lastName', nationalID = '$nationalID', dateOfBirth = '$dateOfBirth', age = '$age', gender = '$gender', contactAddress = '$contactAddress', telHome = '$telHome', telMobile = '$telMobile', emailAddress = '$emailAddress', adminDistrict = '$adminDistrict', nationality = '$nationality', race = '$race', religion = '$religion', ALIndexNumber = '$ALIndexNumber', ALYear = '$ALYear', OLIndexNumber = '$OLIndexNumber', OLYear = '$OLYear', phyDisabilityFlag = '$phyDisabilityFlag' WHERE applicantID = '" . $_SESSION['applicantID'] . "'";
					  mysqli_query($dbc, $query);
					  
					  $query2 = "UPDATE preferences SET preference01 = '$preference01', preference02 = '$preference02', preference03 = '$preference03', preference04 = '$preference04', preference05 = '$preference05', preference06 = '$preference06', preference07 = '$preference07', preference08 = '$preference08', preference09 = '$preference09', preference10 = '$preference10', preference11 = '$preference11', preference12 = '$preference12', preference13 = '$preference13', preference14 = '$preference14', preference15 = '$preference15', preference16 = '$preference16', preference17 = '$preference17', preference18 = '$preference18', preference19 = '$preference19', preference20 = '$preference20' WHERE ALIndexNumber = '" . $_SESSION['ALIndexNumber'] . "'";
					  mysqli_query($dbc, $query2);
					  
					  // Confirm success with the user
					  $error_msg = 'Your application has been successfully updated.';
					  mysqli_close($dbc);
					  ...
					  while ($row7 = mysqli_fetch_array($data7)) {
						  ...
						  if ($days > 1) {
							  ...
							  $deadline_error_msg2 = "The deadline has passed. You cannot edit your application now.";
						  } else {
					...
					$error_msg = 'You must enter all of the application data.';
					// Check if the deadline has passed.
					// If it has passed, don't show the application. Give an error message saying the deadline has passed.
					// If it has not passed, show the amount of days left for the deadline.
				  ...
				  if ($row != NULL) {
					  ...
					  $OLIndexNumber = $row['OLIndexNumber'];
					  $zScore = $row['zScore'];
					  $numberOfAttempts = $row['numberOfAttempts'];
					  $phyDisabilityFlag = $row['phyDisabilityFlag'];
					  
					  $query2 = "SELECT CGTGrade, year FROM ALResult WHERE indexNumber = '$ALIndexNumber'";
					  $data2 = mysqli_query($dbc, $query2);
					  $row2 = mysqli_fetch_array($data2);
					  
					  $CGTGrade = $row2['CGTGrade'];
					  $ALYear = $row2['year'];
					  
					  $query3 = "SELECT year FROM OLResult WHERE indexNumber = '$OLIndexNumber'";
					  $data3 = mysqli_query($dbc, $query3);
					  $row3 = mysqli_fetch_array($data3);
					  
					  $OLYear = $row3['year'];
					  
					  $query4 = "SELECT * FROM preferences WHERE ALIndexNumber = '$ALIndexNumber'";
					  $data4 = mysqli_query($dbc, $query4);
					  $row4 = mysqli_fetch_array($data4);
					  
					  $preference01 = $row4['preference01'];
					  $c1 = substr($preference01, 0, 3);
					  $u1 = substr($preference01, 3, 3);
					  
					  $preference02 = $row4['preference02'];
					  $c2 = substr($preference02, 0, 3);
					  $u2 = substr($preference02, 3, 3);
					  
					  $preference03 = $row4['preference03'];
					  $c3 = substr($preference03, 0, 3);
					  $u3 = substr($preference03, 3, 3);
					  
					  $preference03 = $row4['preference03'];
					  $c3 = substr($preference03, 0, 3);
					  $u3 = substr($preference03, 3, 3);
					  
					  $preference04 = $row4['preference04'];
					  $c4 = substr($preference04, 0, 3);
					  $u4 = substr($preference04, 3, 3);
					  
					  $preference05 = $row4['preference05'];
					  $c5 = substr($preference05, 0, 3);
					  $u5 = substr($preference05, 3, 3);
					  
					  $preference06 = $row4['preference06'];
					  $c6 = substr($preference06, 0, 3);
					  $u6 = substr($preference06, 3, 3);
					  
					  $preference07 = $row4['preference07'];
					  $c7 = substr($preference07, 0, 3);
					  $u7 = substr($preference07, 3, 3);
					  
					  $preference08 = $row4['preference08'];
					  $c8 = substr($preference08, 0, 3);
					  $u8 = substr($preference08, 3, 3);
					  
					  $preference09 = $row4['preference09'];
					  $c9 = substr($preference09, 0, 3);
					  $u9 = substr($preference09, 3, 3);
					  
					  $preference10 = $row4['preference10'];
					  $c10 = substr($preference10, 0, 3);
					  $u10 = substr($preference10, 3, 3);
					  
					  $preference11 = $row4['preference11'];
					  $c11 = substr($preference11, 0, 3);
					  $u11 = substr($preference11, 3, 3);
					  
					  $preference12 = $row4['preference12'];
					  $c12 = substr($preference12, 0, 3);
					  $u12 = substr($preference12, 3, 3);
					  
					  $preference13 = $row4['preference13'];
					  $c13 = substr($preference13, 0, 3);
					  $u13 = substr($preference13, 3, 3);
					  
					  $preference14 = $row4['preference14'];
					  $c14 = substr($preference14, 0, 3);
					  $u14 = substr($preference14, 3, 3);
					  
					  $preference15 = $row4['preference15'];
					  $c15 = substr($preference15, 0, 3);
					  $u15 = substr($preference15, 3, 3);
					  
					  $preference16 = $row4['preference16'];
					  $c16 = substr($preference16, 0, 3);
					  $u16 = substr($preference16, 3, 3);
					  
					  $preference17 = $row4['preference17'];
					  $c17 = substr($preference17, 0, 3);
					  $u17 = substr($preference17, 3, 3);
					  
					  $preference18 = $row4['preference18'];
					  $c18 = substr($preference18, 0, 3);
					  $u18 = substr($preference18, 3, 3);
					  
					  $preference19 = $row4['preference19'];
					  $c19 = substr($preference19, 0, 3);
					  $u19 = substr($preference19, 3, 3);
					  
					  $preference20 = $row4['preference20'];
					  $c20 = substr($preference20, 0, 3);
					  $u20 = substr($preference20, 3, 3);
					...
					$error_msg = 'There was a problem accessing your application.';
				  }
				  mysqli_close($dbc);
				}
	  }
...
<head>
  <title>View and Edit Application | UAS</title>
  ...
  <script type="text/javascript">
      $(document).ready(function(){
          $("#viewAndEditApplicationForm").formToWizard({ submitButton: 'submit' })
      });
  </script>
    ...
    <?php
			...
			if (isset($_SESSION['applicantID'])) {
				...
				if (!empty($ALIndexNumber)) {
					...
					echo '<br />';
					echo '<p class="error_message">Your Application ID is = <span class="error_message">' . $applicationID . '</span>.</p>';
					echo '<br />';
					echo '<p>IMPORTANT: Please attach the Application ID to your Supporting Documents and send it to the UGC within 10 days of submitting the application. Applications without Supporting Documents will be discarded.</p>';
	  ?>
        <form action="<? echo $_SERVER['PHP_SELF']; ?>" method="post" class="register" id="viewAndEditApplicationForm" name="viewAndEditApplicationForm">
            <fieldset class="row2">
            ...
            <p>
                ...
                <input type="text" id="dateOfBirth" name="dateOfBirth" size="11" maxlength="10" onBlur="validateDate(this, document.getElementById('dateOfBirth_help'))" value="<?php if (!empty($dateOfBirth)) echo $dateOfBirth; ?>"/>
          ...
          <fieldset class="row4">
			...
			<?php
            if ($days >= 1) {
			echo '<input name="submit" id="submit" type="submit" value="Edit Application" />';
			}
			?>
