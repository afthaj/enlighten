...
<head>
  <title>Sponsors | Enlighten Admin</title>
  ...
  <div id="main">
    <div id="header">
      ...
      <div id="menubar">
        <ul id="menu">
          ...
          <li class="selected"><a href="adminSponsors.php">Sponsors</a></li>
    ...
    <div id="site_content">
      ...
      <table align="center" width="100%" border="0">
        <tr align="center">
          <td><h2><a href="adminAddSponsor.php">Add Sponsor</a></h2></td>
          <td><h2><a href="adminViewAndEditSponsor.php">View/Edit Sponsor</a></h2></td>
          <td><h2><a href="adminRemoveSponsor.php">Remove Sponsor</a></h2></td>
        </tr>
      </table>
