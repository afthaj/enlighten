...
<head>
  <title>Admin Users | Enlighten Admin</title>
...
<body>
  <div id="main">
    <div id="header">
      ...
      <div id="menubar">
        <ul id="menu">
          ...
          <li class="selected"><a href="adminAdminUsers.php">Admin Users</a></li>
    ...
    <div id="site_content">
      ...
      <p>Welcome to the Admin Users Panel of the University Admission System. In this page, you can add an admin user, view/edit an admin user or remove an admin user.</p>
      
      <table align="center" width="100%" border="0">
        <tr align="center">
          <td><h2><a href="adminAddAdminUser.php">Add Admin User</a></h2></td>
          <td><h2><a href="adminViewAndEditAdminUser.php">View/Edit Admin User</a></h2></td>
          <td><h2><a href="adminRemoveAdminUser.php">Remove Admin User</a></h2></td>
        </tr>
      </table>
